        ...
        <div className="sm:hidden bg-[#030712]/95 backdrop-blur border-b border-slate-800/60 px-4 py-3 flex flex-col gap-1 text-xs font-semibold">
          <Link 
            ...
            className={`px-3 py-2 rounded-lg transition-all ${
              isHome ? 'text-indigo-400 bg-indigo-500/10' : 'text-slate-300 hover:text-white hover:bg-slate-800/60'
            }`}
          >
            Beranda
          </Link>
          ...
          <Link 
            ...
            className={`px-3 py-2 rounded-lg transition-all flex items-center gap-1.5 ${
              location.pathname === '/populer-alltime' ? 'text-indigo-400 bg-indigo-500/10' : 'text-slate-300 hover:text-white hover:bg-slate-800/60'
            }`}
          >
          ...
          <Link 
            ...
            onClick={() => setMobileOpen(false)}
            className={`px-3 py-2 rounded-lg transition-all flex items-center gap-1.5 ${
              location.pathname === '/jadwal' ? 'text-indigo-400 bg-indigo-500/10' : 'text-slate-300 hover:text-white hover:bg-slate-800/60'
            }`}
          >
